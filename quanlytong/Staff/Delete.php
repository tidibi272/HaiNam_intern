...
if(isset($_POST['button1']))
  {
      ...
      if ( mysql_num_rows (mysql_query("SELECT * FROM quanly where msquanly='$text1'") )!=0 && ($text2="COMFIRM)" ))
        {
...
if(isset($_POST['button2']))
  {
    ...
    if ( mysql_num_rows (mysql_query("SELECT * FROM nhanvien where msnv='$text5'") )!=0 && ($text6="COMFIRM"))
    {
              ...
              <div class = "col">
               <form method="post" action="" class="container">
                  <fieldset class="fieldset2">
                      ...
                      <br>
                      <br>
                          <input type = "submit" name="button2" value= "Delete"  class="btn btn-lg btn-primary" style="margin-left: 200px;margin-top: 20px;">
                  </fieldset>
               </form>
              </div>
            </div>
